...
setuptools.setup(
    ...
    packages=["DiscordInterpythons.abcs", "DiscordInterpythons.handlers", "DiscordInterpythons.handlers.middleware", "DiscordInterpythons.models", "DiscordInterpythons.providers", "DiscordInterpythons.utils"],
)
